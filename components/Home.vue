<template>
  <div class="relative flex items-top justify-center min-h-screen bg-white sm:items-center sm:pt-0">
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      <img class="mx-auto" src="https://upload.wikimedia.org/wikipedia/en/3/34/Gfinity_Logo_2020.png" />
      <div class="mt-8 bg-black overflow-hidden shadow sm:rounded-lg p-6">
        <h1 class="text-2xl leading-7 font-semibold">
          Welcome to the <span class="text-[#e62932]">Gfinity GDM Team Assignment</span>
        </h1>
        <p>Completed by: Jeffrey Cheung</p>
        <h2 class="text-xl mt-4 pt-4 border-t border-dashed border-[#e62932]">
          <NuxtLink to="/players" class="hover:underline hover:text-[#e62932]">
            Click here to go to the <code
              class="bg-white hover:bg-[#e62932] p-1 rounded text-black hover:text-white">List Page</code>
          </NuxtLink>
        </h2>
      </div>
      <div class="flex justify-center pt-4 space-x-2">
        <a href="https://github.com/jsc604/gfinity-GDM" target="_blank"><svg
            class="w-6 h-6 text-gray-600 hover:text-gray-800 button--github" xmlns="http://www.w3.org/2000/svg"
